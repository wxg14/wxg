...
signals:
	...
	//void outCom(int aid, float cx, float cy, float cz);double ax, double ay, double az, double gx, double gy, double gz, int cx, int cy, int cz
	void outCom(int aid,float ax, float ay, float az, float gx, float gy, float gz, float cx, float cy, float cz); 
